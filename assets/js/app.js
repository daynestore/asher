/**
 * DAYNE STORE — UI Controller
 * Handles navigation, modals, toasts, PIN auth, and module rendering.
 */

// ── Icons (SVG strings for inline use) ──
const ICONS = {
  store:      `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75v3.75c0 .415.336.75.75.75z"/></svg>`,
  ...
  utang:      `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/></svg>`,
  gcash:      `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3"/></svg>`,
  ...
  search:     `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 15.803 7.5 7.5 0 0015.803 15.803z"/></svg>`,
  close:      `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>`,
  check:      `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>`,
  ...
  arrowUp:    `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 19.5v-15m0 0l-6.75 6.75M12 4.5l6.75 6.75"/></svg>`,
  arrowDown:  `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75"/></svg>`,
  ...
  download:   `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3"/></svg>`,
...
const Toast = {
  show(message, type = 'info', duration = 3500) {
    ...
    const icons = {
      success: `<svg class="toast-icon" style="color:var(--color-success)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>`,
      error:   `<svg class="toast-icon" style="color:var(--color-danger)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/></svg>`,
      warning: `<svg class="toast-icon" style="color:var(--color-warning)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z"/></svg>`,
      info:    `<svg class="toast-icon" style="color:var(--color-info)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"/></svg>`
    };
    const el = document.createElement('div');
    el.className = `toast-item toast-${type}`;
    el.setAttribute('role', 'status');
    el.setAttribute('aria-live', 'polite');
    el.innerHTML = `${icons[type]}<span class="toast-message">${message}</span>`;
...
const App = {
  init() {
    App.renderSidebar();
    App.renderPageSkeletons();
    App.bindGlobal();
    Theme.init();
    // Check if already authenticated this session
    if (sessionStorage.getItem('ds_auth') === 'true') {
      App.enter();
    }
  },
  renderSidebar() {
    ...
    // Logo
    if (settings.logo) {
      document.getElementById('sidebarLogoIcon').innerHTML = `<img src="${settings.logo}" alt="logo" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;">`;
    } else {
      document.getElementById('sidebarLogoIcon').innerHTML = ICONS.store;
    }
  },
  renderPageSkeletons() {
    // Pages are rendered inline in HTML, this just sets up the page title.
  },
  bindGlobal() {
...
const Theme = {
  ...
  init() {
    // Read preference
    const saved = localStorage.getItem('daynestore_theme');
    if (saved === 'dark') {
      Theme.isDark = true;
    } else if (saved === 'light') {
      Theme.isDark = false;
  ...
  toggle() {
    ...
    localStorage.setItem('daynestore_theme', Theme.isDark ? 'dark' : 'light');
    Theme.apply();
  },
  apply() {
...
const PIN = {
  ...
  press(digit) {
    ...
    PIN.entered += digit;
    PIN.updateDots();
    if (PIN.entered.length === PIN.MAX) PIN.verify();
  },
  backspace() {
  ...
  verify() {
    ...
    if (PIN.entered === correct) {
      ...
      setTimeout(() => {
        ...
        dots.forEach(d => { d.style.background = 'var(--color-danger)'; });
        setTimeout(() => { PIN.reset(); }, 700);
      }, 10);
    }
  },
  reset() {
  ...
  updateDots() {
    const dots = document.querySelectorAll('.pin-dot');
    dots.forEach((d, i) => d.classList.toggle('filled', i < PIN.entered.length));
  }
};
...
const Confirm = {
  ...
  show(message, onConfirm, title = 'Confirm Action') {
    ...
    document.getElementById('confirm-message-el').textContent = message;
    Confirm.callback = onConfirm;
    Modal.open('confirmModal');
  },
  ok() {
    if (typeof Confirm.callback === 'function') Confirm.callback();
...
function fmt(n)  { return DS.fmt.currency(n); }
